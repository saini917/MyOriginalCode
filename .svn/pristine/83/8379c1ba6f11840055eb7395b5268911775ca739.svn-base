 ...
 * @Date: 21-11-2017
 * Purpose: ToVerify the Functionality of M-Legal
 */
public class ToverifyfunctionalityofM_Legal extends CommonLibrary 
{
	...
	public void toVerifyMenuFieldsonDashBoard_SC_02_TC01() throws InterruptedException
	{
		try
		{
			waitForSomeTime();
	...
	public void toVerifyMenuFieldsonPendingApplication_SC_02_TC_02()
	...
	public void toVerifyPendingApplicationLink_SC_02_TC_02() throws InterruptedException
	{
	...
	@FindBy(xpath="//div[@class='ui-accordion-content ui-helper-reset ui-widget-content']/div/div[2]/table/tbody/tr/td[2]/a")
	private  List<WebElement> CaseNumbers;
	
	
	public void toVerifyCaseNumberForwardedByAM_Manager_SC_02_TC_03() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
		{
			waitForSomeTime();
	...
	public void VeriftMenuTabsInApplicationNumber_SC_02_TC_03() throws InterruptedException
	{
		waitForSomeTime();
	...
	public void toVerifyFunctionalityofAdvocateButton_SC_02_TC_04() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		waitForSomeTime();
	...
	public void toVerifyCaseNumberForwardedByAM_Manager_SC_02_TC_003() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		waitForSomeTime();
		String Application_Number=excel.getExcelData1("AM_CaseNumber", 0, 1);
		Reporter.log("Application NumberIs:"+Application_Number,true);
		...
		List<WebElement> allpages = driver.findElements(By.xpath("//h3[contains(.,'New Case')]/../div[1]/div/div[4]/span[4]/span"));
	...
	public void toVerifyFunctionalityofOICButton_SC_02_TC_05() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		waitForSomeTime();
	...
	public void toVerifyFunctionalityofSelectActionDropdown_SC_02_TC_06() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
	waitForSomeTime();
	ScroolDown();
	...
	/*	for(int i=1;i<selectAction_DropdownValues.size();i++)
		...
		for(int j=1;j<selectUser_DropdownValues.size();j++)
		{
			waitForSomeTime();
			String value1=selectUser_DropdownValues.get(j).getText();
			Reporter.log("selectUser_DropdownValues:"+value1,true);
			//Reporter.log("selectUser_DropdownValues:"+value1);
		}
		waitForSomeTime();
	...
	public void toVerifyFunctionalityofSelectActionDropdown_SC_02_TC_07() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
	waitForSomeTime();
	ScroolDown();
		HighlightOnElement(selectAction_Dropdown);
		...
		//selectUser_Dropdown.click();
		//selectValueFromDropdown("Rajesh Singh (GM-LEGAL)");
		SelectVisibleText(selectUser_Dropdown, "Rajesh Singh (GM-LEGAL)");
		/*for(int i=1;i<selectUser_DropdownValues.size();i++)
		{
			...
			if(value.equalsIgnoreCase("Rajesh Singh (GM-LEGAL)"))
			{
	...
	public void toVerifyFunctionalityofEnterCommentsField_SC_02_TC_08() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException, AWTException
	{
		waitForSomeTime();
		ScroolDown();
		ScroolDown();
		...
		excel.getExcelData(Enter_CommentsField, "Application_AM_LEGAL", 2, 26);
	...
	public void toVerifyFunctionalityofCloseButton_SC_02_TC_10() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException, AWTException
	{
		ScroolDown();
		ScroolDown();
	...
	public void toVerifyFunctionalityofSubmitButton_SC_02_TC_09() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException, AWTException
	{
		ScroolDown();
		ScroolDown();
