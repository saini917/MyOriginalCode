...
public class ToVerifyPlumberRegistration_SC_02_TC_15 extends CommonLibrary
{
	...
	public void enterTotalOfYearExperience() throws EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		excel.getExcelData(totalyearofexperience,"Plumber Data",2,0);
	}
	
	public void enterTotalOfYearExperience1() throws EncryptedDocumentException, InvalidFormatException, IOException
	{
		wait.until(ExpectedConditions.visibilityOf(totalyearofexperience));
		Assert.assertTrue(totalyearofexperience.isDisplayed());
		HighlightOnElement(totalyearofexperience);
		Assert.assertTrue(totalyearofexperience.isEnabled());
		excel.getExcelData(totalyearofexperience,"Plumber Data",3,0);
	}
	
	public void enterTotalOfYearExperience2() throws EncryptedDocumentException, InvalidFormatException, IOException
	{
		wait.until(ExpectedConditions.visibilityOf(totalyearofexperience));
		Assert.assertTrue(totalyearofexperience.isDisplayed());
		HighlightOnElement(totalyearofexperience);
		Assert.assertTrue(totalyearofexperience.isEnabled());
		excel.getExcelData(totalyearofexperience,"Plumber Data",4,0);
	}
