...
public class ToverifyRTILoginAsCitizen extends CommonLibrary 
	{
		 ...
		 */
		/*****************************************************************************************************/
		@FindBy(xpath="//td[@class='rightColWithLeftPad']/span/table/tbody/tr/td/div/h3/following-sibling::div/table/tbody/tr/td/span[contains(text(),'ONLINE RTI')]/../following-sibling::td/span/a/img[@src='/NRDAuthority_TEST/javax.faces.resource/applyNow.png.xhtml?ln=img'] ")
...
//			waitForSomeTime();
		...
		*/
		...
		public void toverifyfunctionalityofUploadButtonwithInvalidFile_SC_03_TC_07() throws InterruptedException, AWTException
		{
			...
			String Expected_Message="Upload File with extension jpeg , jpg , png and pdf file;";
...
*/			waitForSomeTime();
	...
	*/
		...
		@FindBy(xpath="//img[@src='/NRDAuthority_TEST/resources/images/view-icon.png']")
