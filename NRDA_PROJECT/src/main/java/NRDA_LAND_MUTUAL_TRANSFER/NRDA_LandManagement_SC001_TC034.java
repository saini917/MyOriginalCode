...
public class NRDA_LandManagement_SC001_TC034  extends CommonLibrary{
	...
	public void clickOnSubmit() throws InterruptedException, AWTException{
		submit(submit);
	}
	...
	public void getApplicationNum() throws EncryptedDocumentException, InvalidFormatException, IOException{
		...
		excel.updateLandMutualTransferAppNum(appnumber);
	}
