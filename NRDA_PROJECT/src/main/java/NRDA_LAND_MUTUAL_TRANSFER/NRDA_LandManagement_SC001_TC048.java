...
public class NRDA_LandManagement_SC001_TC048 extends CommonLibrary{
	...
	@FindBy(xpath="(//label[contains(text(),'Subject')]/../following-sibling::td/input)[1]")
	...
	@FindBy(xpath="(//label[contains(text(),'File Number')]/../following-sibling::td/table/tbody/tr/td/input)[1]")
