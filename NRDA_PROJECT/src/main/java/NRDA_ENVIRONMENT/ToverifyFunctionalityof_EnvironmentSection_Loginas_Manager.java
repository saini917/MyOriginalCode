 ...
 * @Date: 15-12-2017
 */
public class ToverifyFunctionalityof_EnvironmentSection_Loginas_Manager extends CommonLibrary 
{
	...
	public void toverifyDashBoardMenu_SC_06_TC_01() throws InterruptedException
	 {
	  try
		{ 
	...
	public void toVerifySearchFieldAsPendingApplicationNumberAsEnterNumericonly_SC_06_TC_07() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
	...
	public void toVerifyPendingApplicationWithValidNumber_SC_06_TC_08() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
	...
	public void toVerifyfunctionalityPendingApplicationbyselectingspecificapplication_SC_06_TC_09() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
	...
	public void toVerifyfunctionalitySelectingForward_SC_06_TC_10() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		waitForSomeTime();
		selectValueFromDropdown("R.P  Shrivastava (EE)");
	...
	public void toVerifyfunctionalitySelectingForward_SC_06_TC_15() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
	...
	public void toVerifyfunctionalityPrintButton_SC_06_TC_11() throws InterruptedException
	{
	...
	public void toVerifyfunctionalityofUploadingInvalidDocument_SC_06_TC_12() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException, AWTException
	{		
	...
	public void toVerifyfunctionalityofUploadingDocument_SC_06_TC_13() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException, AWTException
	{
		HighlightOnElement(UploadingDocument);
		UploadingDocument.click();
		waitForSomeTime();
	...
	public void toVerifyErrorMsgonCommentfieldAsBlank_SC_06_TC_14() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException, AWTException
	{		
	...
	public void toVerifyfunctionalityofEnterCommentsField() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException, AWTException
	{
		...
		excel.getExcelData(EnterCommentsField, "Environmental_Application_Form", 1, 58);
		waitForSomeTime();
	...
	@FindBy(xpath="//a[contains(.,'Environment NOC')]/../following-sibling::div[1]/div/div/div/div[1]/table/thead/tr/th/span")
	private List <WebElement> EnvironmentNOC__Menu;
	
	public void toVerifyPendingApplicationMenulist1() throws InterruptedException
	{
		...
		waitForSomeTime();
		for(WebElement menulist:EnvironmentNOC__Menu)
		{
			HighlightOnElement(menulist);
			Assert.assertNotNull(menulist.isDisplayed(),"Test case pass");
			if(menulist.isDisplayed())
