...
public class NRDA_PRO_SC_08_TC_06 extends CommonLibrary
{
	...
	public void selectFinance() throws InterruptedException
	{
		wait.until(ExpectedConditions.visibilityOf(finance));
		Assert.assertTrue(finance.isDisplayed());
		HighlightOnElement(finance);
		Assert.assertTrue(finance.isEnabled());
		finance.click();
		selectValueFromDropdown("Arjun Kumar Chandrakar (MGR)");
		waitForSomeTime();
	}
