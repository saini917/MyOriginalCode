...
public class NRDA_PRO_SC_09_TC_08 extends CommonLibrary
{
	...
	/****************************************************************************************************/
	/*
	 * This is the xpath of the WebElement "select GM".
	 * @author deepak.saini
	 * @since 2018-02-15
	 */
	/*****************************************************************************************************/
	...
	private WebElement GMfinance;
	
	public void selectGMfinance() throws InterruptedException
	{
		wait.until(ExpectedConditions.visibilityOf(GMfinance));
		Assert.assertTrue(GMfinance.isDisplayed());
		HighlightOnElement(GMfinance);
		Assert.assertTrue(GMfinance.isEnabled());
		GMfinance.click();
		selectValueFromDropdown("A.K. Jha (Con)");
		waitForSomeTime();
	}
