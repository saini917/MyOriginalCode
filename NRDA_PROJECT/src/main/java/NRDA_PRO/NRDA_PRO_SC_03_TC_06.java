...
public class NRDA_PRO_SC_03_TC_06 extends CommonLibrary
{
	...
	public void selectConsultant() throws InterruptedException
	{
		wait.until(ExpectedConditions.visibilityOf(consultant));
		Assert.assertTrue(consultant.isDisplayed());
		HighlightOnElement(consultant);
		Assert.assertTrue(consultant.isEnabled());
		consultant.click();
		selectValueFromDropdown("Mrs. Neha Sharaswat (Con)");
		waitForSomeTime();
	}
