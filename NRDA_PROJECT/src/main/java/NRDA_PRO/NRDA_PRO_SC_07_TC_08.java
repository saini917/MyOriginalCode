...
public class NRDA_PRO_SC_07_TC_08 extends CommonLibrary
{
	...
	/****************************************************************************************************/
	/*
	 * This is the xpath of the WebElement "Bill date".
	 * @author deepak.saini
	 * @since 2018-05-11
	 */
	/*****************************************************************************************************/
	@FindBy(xpath="//label[contains(text(),'Bill Date')]/../following-sibling::td/span/input")
	private WebElement billdate;

	public void selectBillDate() throws InterruptedException
	{	
		//Get Today's number
