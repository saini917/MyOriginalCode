...
public class NRDA_LandManagement_SC016_TC035 extends CommonLibrary
{
	 ...
	 */
	/*****************************************************************************************************/
	@FindBy(xpath="//div/span[contains(text(),'Please Select User')]")
	private WebElement msg;
	
	public void verifyErrorMsg() throws InterruptedException
	{
		String actual="Please Select User";
