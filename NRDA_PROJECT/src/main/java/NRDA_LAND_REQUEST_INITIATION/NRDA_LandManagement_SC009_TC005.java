...
public class NRDA_LandManagement_SC009_TC005 extends CommonLibrary
{
	...
	//@FindBy(xpath="//div[@id='inboxForm:srchDlg']/div/div/div/center/table/tbody/tr/td/button/span[contains(text(),'Close')]")
