...
public class NRDA_LandManagement_SC003_TC004 extends CommonLibrary
{
	...
	public void enterValidLandArea() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		excel.getExcelData(landarea,"Land Data",3,0);
	}
