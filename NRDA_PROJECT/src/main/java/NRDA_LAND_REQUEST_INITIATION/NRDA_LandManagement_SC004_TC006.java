...
public class NRDA_LandManagement_SC004_TC006 extends CommonLibrary
{
	...
	/****************************************************************************************************/
	/*
	 * This is the xpath of the WebElement "requested type organization".
	 * @author deepak.saini
	 * @since 2018-05-14
	 */
	/****************************************************************************************************/
	...
	public void selectRequestTypeOrganization() throws InterruptedException
	{
		...
		SelectVisibleText(requestedtype,"ORGANISATION");
		waitForSomeTime();
		waitForSomeTime();
	}
