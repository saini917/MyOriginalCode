...
public class NRDA_LandManagement_SC004_TC001 extends CommonLibrary
{
	...
	public void selectRequestByOTHER() throws InterruptedException
	{
		waitForSomeTime();
		waitForSomeTime();
		waitForSomeTime();
		...
		SelectVisibleText(requestedby,"OTHER");
		waitForSomeTime();
		waitForSomeTime();
		waitForSomeTime();
		waitForSomeTime();
