...
public class NRDA_LandManagement_SC003_TC002 extends CommonLibrary
{
	...
	public void enterInvalidLandArea() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		excel.getExcelData(landarea,"Land Data",1,0);
		clickonany.click();
		acceptAlert();
	}
