...
public class NRDA_LandManagement_SC020_TC015 extends CommonLibrary
{
	...
	@FindBy(xpath="(//div[@class='note-sheet-wrapper-left'])[6]/div/div/label")
	List<WebElement> display32;
	
	@FindBy(xpath="(//div[@class='note-sheet-wrapper-left'])[7]/div/div/label")
	List<WebElement> display33;
	...
	@FindBy(xpath="//div[@class='note-sheet-wrapper-left']/div[contains(text(),'APPLICATION FORWARD TO LAND SECTION')]")
	private WebElement display7;
	
	@FindBy(xpath="//div[@class='note-sheet-wrapper-left']/div[contains(text(),'APPLICATION FORWARD TO GENERAL MANAGER')]")
	private WebElement display8;
	
	@FindBy(xpath="//div[@class='note-sheet-wrapper-left']/div[contains(text(),'APPLICATION FORWARD TO CEO')]")
	private WebElement display9;
	...
	public void verifyDisplay()
	{
		...
		for(WebElement list:display32)
		{
			Assert.assertTrue(list.isDisplayed());
			HighlightOnElement(list);
		}
		
		for(WebElement list:display33)
		{
			Assert.assertTrue(list.isDisplayed());
			HighlightOnElement(list);
		}
		...
		Assert.assertTrue(display8.isDisplayed());
		HighlightOnElement(display8);
		
		Assert.assertTrue(display7.isDisplayed());
		HighlightOnElement(display9);
	}
