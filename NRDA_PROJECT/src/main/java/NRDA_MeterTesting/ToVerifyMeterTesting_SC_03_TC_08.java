...
public class ToVerifyMeterTesting_SC_03_TC_08 extends CommonLibrary
{
	...
	/****************************************************************************************************/
	/*
	 * This is the xpath of the WebElement "select verify".
	 * @author deepak.saini
	 * @since 2018-03-26
	 */
	/*****************************************************************************************************/
	...
	public void selectVerifyAction() throws InterruptedException
	{
	...
	public void selectMeterStatusAction() throws InterruptedException
	{
		...
		meterstatus.click();
		selectValueFromDropdown("Faulty");
		waitForSomeTime();
	}
