...
public class ToVerifyUploadDocument_SC_03_TC_61 extends CommonLibrary
{
	...
	@FindBy(xpath="//div[@class='ui-growl-message']/span[contains(text(),'Upload File with extension jpeg , jpg , png and pdf file')]")
	private WebElement errormsg;
	
	public void getErrorMsg()
	{
		String actual="Upload File with extension jpeg , jpg , png and pdf file";
