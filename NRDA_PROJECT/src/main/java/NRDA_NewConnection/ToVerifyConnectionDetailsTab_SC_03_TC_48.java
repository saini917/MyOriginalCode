...
public class ToVerifyConnectionDetailsTab_SC_03_TC_48 extends CommonLibrary
{
	...
	private WebElement trust_organisation_school10;
	...
	private WebElement numberof_student_seat_employee10;
	...
	private WebElement sewerage_connection_diameter10;
	 ...
	 */
	/****************************************************************************************************/
	@FindBy(xpath="//table[@style='width: 100%;border-collapse: collapse;border: 0;']/tbody/tr/td/table/tbody/tr[8]/td[2]/table/tbody/tr/td[2]/table/tbody/tr/td/textarea")
	private WebElement remarks5;
	...
	public void verifyFilledFunctionality() throws InterruptedException
	{
		...
		try
		{
			HighlightOnElement(trust_organisation_school10);
			excel.getExcelData(trust_organisation_school10, "Connection Details",4,4);
			...
			HighlightOnElement(numberof_student_seat_employee10);
			//waitForSomeTime();
			excel.getExcelData(numberof_student_seat_employee10,"Connection Details",3,7);
			...
			HighlightOnElement(sewerage_connection_diameter10);
			//waitForSomeTime();
			excel.getExcelData(sewerage_connection_diameter10, "Connection Details",1,9);
			//Reporter.log("Sewerage Coonection Number:"+sewerageConnectionNumber,true);
			log.info("To Verify enter the value in Sewerage Connection diameter textbox sucessfully");
			//waitForSomeTime();

			HighlightOnElement(remarks5);
			excel.getExcelData(remarks5, "Connection Details",1,12);
			//Reporter.log(remarksIfAny5,true);
