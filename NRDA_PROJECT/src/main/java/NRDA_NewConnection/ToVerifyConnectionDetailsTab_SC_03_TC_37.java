...
public class ToVerifyConnectionDetailsTab_SC_03_TC_37 extends CommonLibrary
{
						...
						for(int index1=1;index1<all_connection_type.size();index1++)
						{
							...
							if(conn_type.trim().equalsIgnoreCase("Residential Cum Commercial/आवासीय सह वाणिज्यिक"))
							{
								...
								for(int index2=1;index2<all_details_of_usage.size();index2++)
								{
									...
									if(details_usage.trim().equalsIgnoreCase("Nurses Home and Medical Quarter/नर्स होम और मेडिकल क्वार्टर"))
									{
