...
public class ToVerifyConnectionDetailsTab_SC_03_TC_45 extends CommonLibrary
{
	...
	private WebElement sewerage_connection_diameter2;
	 ...
	 */
	/****************************************************************************************************/
	@FindBy(xpath="//table[@style='width: 100%;border-collapse: collapse;border: 0;']/tbody/tr/td/table/tbody/tr[10]/td[1]/table/tbody/tr/td[2]/table/tbody/tr/td/span/div/div[1]/label/input")
	private WebElement site_plan2;
	 ...
	 */
	/****************************************************************************************************/
	@FindBy(xpath="//table[@style='width: 100%;border-collapse: collapse;border: 0;']/tbody/tr/td/table/tbody/tr[12]/td[1]/table/tbody/tr/td[2]/table/tbody/tr/td/textarea")
	...
	public void verifyFilledFunctionality() throws InterruptedException
	{
		...
		try
		{
			HighlightOnElement(sewerage_connection_diameter2);
			waitForSomeTime();
			excel.getExcelData(sewerage_connection_diameter2, "Connection Details",4,10);
			//Reporter.log("Sewearge Connection Diameter:"+sewerageConnectionDiameter2,true);
			log.info("To Verify enter the value in Sewerage Connection Diameter textbox sucessfully");
			//waitForSomeTime();

			HighlightOnElement(site_plan2);
			site_plan2.click();
			waitForSomeTime();
			...
			HighlightOnElement(remarks2);
			excel.getExcelData(remarks2, "Connection Details",2,12);
			//Reporter.log("Remarks(if Any):"+remarksIfAny2,true);
