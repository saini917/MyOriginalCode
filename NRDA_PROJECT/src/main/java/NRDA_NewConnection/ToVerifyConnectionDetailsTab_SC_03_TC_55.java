...
public class ToVerifyConnectionDetailsTab_SC_03_TC_55 extends CommonLibrary
{
	...
	private WebElement trust_organisation_school13;


	/****************************************************************************************************/
	/*
	 * This is the xpath of the WebElement "Number of Flats".
	 * @author deepak.saini
	 * @since 2017-08-23
	 */
	/****************************************************************************************************/
	...
	private WebElement numberof_flats13;
	 ...
	 */
	/****************************************************************************************************/
	@FindBy(xpath=" //td[@class='rightColWithLeftPad']/span/span/span/div/div[2]/div/div/div[3]/table/tbody/tr/td/table/tbody/tr[2]/following-sibling::tr[5]/td[1]/table/tbody/tr/td[2]/table/tbody/tr/td/input")
	private WebElement sewerage_connection_diameter13;
	 ...
	 */
	/****************************************************************************************************/
	@FindBy(xpath=" //td[@class='rightColWithLeftPad']/span/span/span/div/div[2]/div/div/div[3]/table/tbody/tr/td/table/tbody/tr[2]/following-sibling::tr[5]/td[2]/table/tbody/tr/td[2]/table/tbody/tr/td/span/div/div[1]/label/input")
	private WebElement site_plan13;
	 ...
	 */
	/****************************************************************************************************/
	@FindBy(xpath="//table[@style='width: 100%;border-collapse: collapse;border: 0;']/tbody/tr/td/table/tbody/tr[9]/td[2]/table/tbody/tr/td[2]/table/tbody/tr[1]/td/textarea")
	private WebElement remarks13;
	...
	public void verifyFilledFunctionality() throws InterruptedException
	{
						...
						for(int index1=0;index1<all_connection_type.size();index1++)
						{
							...
							if(conn_type.trim().equalsIgnoreCase("Domestic/घरेलू"))
							{
								...
								for(int index2=0;index2<all_details_of_usage.size();index2++)
								{
									...
									if(details_usage.trim().equalsIgnoreCase("Society Building/सोसाइटी बिल्डिंग"))
									{
										waitForSomeTime();
		...
		try
		{
			HighlightOnElement(trust_organisation_school13);
			excel.getExcelData(trust_organisation_school13, "Connection Details",9,4);
			//Reporter.log("Number of Trust/Organisation/Schools:"+organisation,true);
			log.info("To Verify enter the value in Trust/Organisation/School textbox sucessfully");

			HighlightOnElement(numberof_flats13);
			excel.getExcelData(numberof_flats13, "Connection Details",3,6);
			//Reporter.log("Number of Flats:"+numberofFlats,true);
			...
			HighlightOnElement(sewerage_connection_diameter13);
			excel.getExcelData(sewerage_connection_diameter13, "Connection Details",3,10);
			//Reporter.log(sewerageConnectionDiameter13,true);
			log.info("To Verify enter the value in Sewerage Connection Diameter textbox sucessfully");

			HighlightOnElement(site_plan13);
			site_plan13.click();
			waitForSomeTime();
			...
			HighlightOnElement(remarks13);
			excel.getExcelData(remarks13, "Connection Details",2,12);
			//Reporter.log("Remarks(if Any):"+remarksIfAny13,true);
