...
public class ToVerifyConnectionDetailsTab_SC_03_TC_47 extends CommonLibrary
{
	...
	private WebElement trust_organisation_school3;
	...
	private WebElement numberof_Students_Rooms_Flats;
	...
	private WebElement sewerage_connection_diameter4;
	 ...
	 */
	/****************************************************************************************************/
	@FindBy(xpath="//table[@style='width: 100%;border-collapse: collapse;border: 0;']/tbody/tr/td/table/tbody/tr[6]/td[1]/table/tbody/tr/td[2]/table/tbody/tr/td/span/div/div[1]/label/input")
	private WebElement site_plan4;
	 ...
	 */
	/****************************************************************************************************/
	@FindBy(xpath="//table[@style='width: 100%;border-collapse: collapse;border: 0;']/tbody/tr/td/table/tbody/tr[8]/td[1]/table/tbody/tr/td[2]/table/tbody/tr/td/textarea")
	private WebElement remarks4;
	...
	public void verifyFilledFunctionality() throws InterruptedException
	{
		...
		try
		{
			HighlightOnElement(trust_organisation_school3);
			excel.getExcelData(trust_organisation_school3,"Connection Details",11,4);
			...
			HighlightOnElement(numberof_Students_Rooms_Flats);
			excel.getExcelData(numberof_Students_Rooms_Flats, "Connection Details",3,8);
			//Reporter.log("Number of Students/Rooms/Flats:"+ numberofStudentsRommsFlats,true);
			...
			HighlightOnElement(sewerage_connection_diameter4);
			//waitForSomeTime();
			excel.getExcelData(sewerage_connection_diameter4, "Connection Details",1,10);
			//Reporter.log("Sewearge Connection Diameter:"+sewerageConnectionDiameter4,true);
			log.info("To Verify enter the value in Sewerage Connection Diameter textbox sucessfully");

			HighlightOnElement(site_plan4);
			site_plan4.click();
			waitForSomeTime();
			...
			HighlightOnElement(remarks4);
			excel.getExcelData(remarks4, "Connection Details",2,12);
			//Reporter.log("Remarks(if Any):"+remarksIfAny4,true);
