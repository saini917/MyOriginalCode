...
public class ToVerifyConnectionDetailsTab_SC_03_TC_56 extends CommonLibrary
{
	...
	private WebElement trust_organisation_school14;
	...
	private WebElement numberof_Bed_Employee_Students14;
	...
	private WebElement clickonanywhere1;
	...
	private WebElement sewerage_connection_diameter14;
	 ...
	 */
	/****************************************************************************************************/
	@FindBy(xpath="//td[@class='rightColWithLeftPad']/span/span/span/div/div[2]/div/div/div[3]/table/tbody/tr/td/table/tbody/tr[2]/following-sibling::tr[6]/td[2]/table/tbody/tr/td[2]/table/tbody/tr/td/span/div/div[1]/label/input")
	private WebElement site_plan14;
	 ...
	 */
	/****************************************************************************************************/
	@FindBy(xpath="//table[@style='width: 100%;border-collapse: collapse;border: 0;']/tbody/tr/td/table/tbody/tr[10]/td[2]/table/tbody/tr/td[2]/table/tbody/tr[1]/td/textarea")
	private WebElement remarks14;
	...
	public void verifyFilledFunctionality() throws InterruptedException
	{
		...
		try
		{
			HighlightOnElement(trust_organisation_school14);
			excel.getExcelData(trust_organisation_school14, "Connection Details",8,4);
			//Reporter.log("Trust/Orgainsation/School:"+organisation,true);
			log.info("To Verify enter the value in Trust/Organisation/School textbox sucessfully");

			HighlightOnElement(numberof_Bed_Employee_Students14);
			excel.getExcelData(numberof_Bed_Employee_Students14, "Connection Details",3,5);
			...
			clickonanywhere1.click();
			waitForSomeTime();




			HighlightOnElement(sewerage_connection_diameter14);
			excel.getExcelData(sewerage_connection_diameter14, "Connection Details",2,10);
			//Reporter.log("Sewerage Connection Diameter:"+sewerageConnectionDiameter14,true);
			log.info("To Verify enter the value in Sewerage Connection Diameter textbox sucessfully");

			HighlightOnElement(site_plan14);
			site_plan14.click();
			waitForSomeTime();
			...
			HighlightOnElement(remarks14);
			excel.getExcelData(remarks14, "Connection Details",2,12);
			//Reporter.log("Remarks(if Any):"+remarksIfAny14,true);
