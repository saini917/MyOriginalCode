...
public class ToVerifyConnectionDetailsTab_SC_10_TC_11 extends CommonLibrary
{
	...
	@FindBy(xpath="(//center)[4]/table/tbody/tr/td/label")
	private List<WebElement> display;
	
	@FindBy(xpath="(//center)[4]/table/tbody/tr/td/a/span")
	private WebElement displays;
	
	@FindBy(xpath="(//center)[4]/table/tbody/tr/td/span[contains(text(),'Upload Document')]")
	private WebElement display1;
	
	@FindBy(xpath="(//center)[5]/button/span")
