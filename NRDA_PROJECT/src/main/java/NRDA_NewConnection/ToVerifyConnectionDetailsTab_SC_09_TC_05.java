...
public class ToVerifyConnectionDetailsTab_SC_09_TC_05 extends CommonLibrary
{
	...
	/****************************************************************************************************/
	/*
	 * This is the xpath of the WebElement "my inbox link".
	 * @author deepak saini
	 * @since 2018-05-04
	 */
	/*****************************************************************************************************/

	@FindBy(xpath="(//td[@class='rightColWithLeftPad']/table/tbody/tr/td/form/div/div/div/div/div/div/div[@class='box-head'])[2]/div/../following-sibling::div/div/div/p[contains(text(),'My Inbox')]/following-sibling::span/a")
	...
	public void clickOnMyInbox() throws InterruptedException
	{
		...
		myinbox.click();
		Reporter.log("My inbox link count:"+myinbox.getText(),true);
		waitForSomeTime();
	}
	...
	private List<WebElement> recordperpage;
	 ...
	 */
	/*****************************************************************************************************/
	@FindBy(xpath="(//div[@class='ui-datatable-tablewrapper'])[1]/table/tbody/tr/td[7]")
	private List<WebElement> actionbtn;
	
	public void verifyDisplay() throws InterruptedException
	{
		for(WebElement list:recordperpage)
		{
			Assert.assertTrue(list.isDisplayed());
			HighlightOnElement(list);
		}
		
		for(WebElement list:actionbtn)
		{
			Assert.assertTrue(list.isDisplayed());
			HighlightOnElement(list);
		}
