...
public class ToVerifyBuildingDetailsTab_SC_03_TC_13 extends CommonLibrary
{
	...
	public void verifyOwnerDetails() throws EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		excel.getExcelData(ownername,"Building Details",1,9);
	...
	public void viewResult()
	{
		...
		Reporter.log("User can select one record from results",true);
	}
