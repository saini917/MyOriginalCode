...
public class ToVerifyUploadDocument_SC_03_TC_59 extends CommonLibrary
{
	...
	/****************************************************************************************************/
	/**
	 * This is the xpath of the WebElement "Service related document"
	 * @author deepak.saini
	 * @since 2018-04-25
	 */
	/****************************************************************************************************/	
	@FindBy(xpath="//label[contains(text(),'Service Related Document')]")
	 ...
	 */
	/****************************************************************************************************/	
	@FindBy(xpath="//label[contains(text(),'Identification Document')]")
	 ...
	 */
	/****************************************************************************************************/
	@FindBy(xpath="//label[contains(text(),'Proof Of Residence Document')]")
	...
	public void verifyDisplayList()
	{
		...
		wait.until(ExpectedConditions.visibilityOf(identification));
		Assert.assertTrue(identification.isDisplayed());
		HighlightOnElement(identification);
		getValueFromDropDown(idvalue);
		
		wait.until(ExpectedConditions.visibilityOf(residence));
		Assert.assertTrue(residence.isDisplayed());
		HighlightOnElement(residence);
		getValueFromDropDown(residencevalue);
	}
