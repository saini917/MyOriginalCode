...
public class ToVerifyConnectionDetailsTab_SC_03_TC_51 extends CommonLibrary
{
	...
	private WebElement trust_organisation_school8;
	...
	private WebElement numberof_Bed_Employee_Students8;
	...
	private WebElement sewerage_connection_number8;
	 ...
	 */
	/****************************************************************************************************/
	@FindBy(xpath="//table[@style='width: 100%;border-collapse: collapse;border: 0;']/tbody/tr/td/table/tbody/tr[10]/td[2]/table/tbody/tr/td[2]/table/tbody/tr/td/textarea")
	private WebElement remarks8;
	...
	public void verifyFilledFunctionality() throws InterruptedException
	{
		...
		try
		{
			HighlightOnElement(trust_organisation_school8);
			waitForSomeTime();
			excel.getExcelData(trust_organisation_school8, "Connection Details",5,4);
			...
			HighlightOnElement(numberof_Bed_Employee_Students8);
			excel.getExcelData(numberof_Bed_Employee_Students8, "Connection Details",2,5);
			...
			HighlightOnElement(sewerage_connection_number8);
			excel.getExcelData(sewerage_connection_number8, "Connection Details",3,9);
			//Reporter.log("Sewerage Coonection Number:"+sewerageConnectionNumber8,true);
			log.info("To Verify enter the value in Sewerage Connection Diameter textbox sucessfully");

			HighlightOnElement(remarks8);
			excel.getExcelData(remarks8, "Connection Details",2,12);
			//Reporter.log("Remarks(if Any):"+remarksIfAny8,true);
