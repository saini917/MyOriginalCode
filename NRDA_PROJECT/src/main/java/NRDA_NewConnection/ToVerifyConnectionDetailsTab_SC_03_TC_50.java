...
public class ToVerifyConnectionDetailsTab_SC_03_TC_50 extends CommonLibrary
{
	...
	private WebElement trust_organisation_school7;
	...
	private WebElement numberof_flats7;
	...
	private WebElement clickingany;
	...
	private WebElement sewerage_connection_number2;
	 ...
	 */
	/****************************************************************************************************/
	@FindBy(xpath="//table[@style='width: 100%;border-collapse: collapse;border: 0;']/tbody/tr/td/table/tbody/tr[9]/td[2]/table/tbody/tr/td[2]/table/tbody/tr/td/textarea")
	private WebElement remarks7;
	...
	public void verifyFilledFunctionality() throws InterruptedException
	{
		...
		try
		{
			HighlightOnElement(trust_organisation_school7);
			excel.getExcelData(trust_organisation_school7, "Connection Details",10,4);
			...
			HighlightOnElement(numberof_flats7);
			excel.getExcelData(numberof_flats7, "Connection Details",4,6);
			...
			HighlightOnElement(sewerage_connection_number2);
			excel.getExcelData(sewerage_connection_number2, "Connection Details",2,9);
			//Reporter.log("Sewerage Coonection Number:"+sewerageConnectionNumber2,true);
			log.info("To Verify enter the value in Sewerage Connection Number textbox sucessfully");

			HighlightOnElement(remarks7);
			excel.getExcelData(remarks7, "Connection Details",2,12);
			//Reporter.log("Remarks(if Any):"+remarksIfAny7,true);
