...
public class ToVerifyConnectionDetailsTab_SC_03_TC_25 extends CommonLibrary
{
	...
	public void selectConnectionConstructionYes() throws InterruptedException
	{
		...
		SelectVisibleText(construction,"Yes / हाँ");
		waitForSomeTime();
		waitForSomeTime();
	}
