...
public class ToVerifyConnectionDetailsTab_SC_03_TC_44 extends CommonLibrary
{
	...
	private WebElement trust_organisation_school1;
	...
	private WebElement numberof_flats;
	...
	private WebElement clickinganyy;
	/****************************************************************************************************/
	/*
	 ...
	 */
	/****************************************************************************************************/
	@FindBy(xpath="//td[@class='rightColWithLeftPad']/span/span/span/div/div[2]/div/div/div[3]/table/tbody/tr/td/table/tbody/tr[3]/following-sibling::tr[4]/td[1]/table/tbody/tr/td[2]/table/tbody/tr/td/input")
	private WebElement sewerage_connection_diameter1;
	 ...
	 */
	/****************************************************************************************************/
	@FindBy(xpath="//td[@class='rightColWithLeftPad']/span/span/span/div/div[2]/div/div/div[3]/table/tbody/tr/td/table/tbody/tr[3]/following-sibling::tr[5]/td[1]/table/tbody/tr/td[2]/table/tbody/tr/td/span/div/div[1]/label/input")
	private WebElement site_plan1;
	 ...
	 */
	/****************************************************************************************************/
	@FindBy(xpath="//td[@class='rightColWithLeftPad']/span/span/span/div/div[2]/div/div/div[3]/table/tbody/tr/td/table/tbody/tr[5]/following-sibling::tr[5]/td/table/tbody/tr/td[2]/table/tbody/tr/td/textarea")
	...
	public void verifyFilledFunctionality() throws InterruptedException
	{
		...
		try
		{
			HighlightOnElement(trust_organisation_school1);
			excel.getExcelData(trust_organisation_school1, "Connection Details",3,4);
			...
			HighlightOnElement(numberof_flats);
			excel.getExcelData(numberof_flats, "Connection Details",1,6);
			...
			HighlightOnElement(sewerage_connection_diameter1);
			excel.getExcelData(sewerage_connection_diameter1, "Connection Details",4,10);
			//Reporter.log("Sewearge Connection Diameter:"+sewerageConnectionDiameter1,true);
			log.info("To Verify enter the value in Sewerage Connection Diameter textbox sucessfully");

			HighlightOnElement(site_plan1);
			site_plan1.click();
			waitForSomeTime();
			...
			HighlightOnElement(remarks1);
			String remarksIfAny1=excel.getExcelData(remarks1, "Connection Details",2,12);
			Reporter.log("Remarks(if Any):"+remarksIfAny1,true);
