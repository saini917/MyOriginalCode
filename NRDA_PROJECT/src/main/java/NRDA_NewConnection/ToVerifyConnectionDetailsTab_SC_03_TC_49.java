...
public class ToVerifyConnectionDetailsTab_SC_03_TC_49 extends CommonLibrary
{
	...
	private WebElement sewerage_connection_number1;
	...
	public void verifyFilledFunctionality() throws InterruptedException
	{
		...
		try
		{
			HighlightOnElement(sewerage_connection_number1);
			excel.getExcelData(sewerage_connection_number1, "Connection Details",1,9);
			//Reporter.log("Sewerage Coonection Number:"+sewerageConnectionNumber1,true);
			log.info("To Verify enter the value in Sewerage Connection Number textbox sucessfully");

			HighlightOnElement(remarks6);
			excel.getExcelData(remarks6, "Connection Details",2,12);
			//Reporter.log("Remarks(if Any):"+remarksIfAny6,true);
