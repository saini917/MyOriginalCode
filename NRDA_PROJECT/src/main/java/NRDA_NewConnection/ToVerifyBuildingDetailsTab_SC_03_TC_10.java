...
public class ToVerifyBuildingDetailsTab_SC_03_TC_10 extends CommonLibrary
{
	 ...
	 */
	/****************************************************************************************************/
	@FindBy(xpath="//div[@id='form0:dlg_propertySearch']/div/div/div/span/table/tbody/tr/td/label[@style='margin-left:20px;']/../following-sibling::td/div/div/span")
	private WebElement clickonsector;
	
	public void selectSector() throws InterruptedException
	{
		wait.until(ExpectedConditions.visibilityOf(clickonsector));
		Assert.assertTrue(clickonsector.isDisplayed());
		HighlightOnElement(clickonsector);
		Assert.assertTrue(clickonsector.isEnabled());
		clickonsector.click();
