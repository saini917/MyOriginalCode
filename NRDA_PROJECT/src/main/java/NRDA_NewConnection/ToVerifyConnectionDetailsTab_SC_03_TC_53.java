...
public class ToVerifyConnectionDetailsTab_SC_03_TC_53 extends CommonLibrary
{
	...
	private WebElement trust_organisation_school11;
	...
	private WebElement numberof_student_seat_employee11;
	 ...
	 */
	/****************************************************************************************************/
	@FindBy(xpath="//td[@class='rightColWithLeftPad']/span/span/span/div/div[2]/div/div/div[3]/table/tbody/tr/td/table/tbody/tr[2]/following-sibling::tr[4]/td[1]//table/tbody/tr/td[2]/table/tbody/tr/td/input")
	private WebElement sewerage_connection_number11;
	 ...
	 */
	/****************************************************************************************************/
	@FindBy(xpath="//td[@class='rightColWithLeftPad']/span/span/span/div/div[2]/div/div/div[3]/table/tbody/tr/td/table/tbody/tr[2]/following-sibling::tr[4]/td[2]//table/tbody/tr/td[2]/table/tbody/tr/td/span/div/div[1]/label/input")
	private WebElement site_plan11;
	 ...
	 */
	/****************************************************************************************************/
	@FindBy(xpath="//table[@style='width: 100%;border-collapse: collapse;border: 0;']/tbody/tr/td/table/tbody/tr[8]/td[2]/table/tbody/tr/td[2]/table/tbody/tr[1]/td/textarea")
	private WebElement remarks11;
	...
	public void verifyFilledFunctionality() throws InterruptedException
	{
		...
		try
		{
			HighlightOnElement(trust_organisation_school11);
			excel.getExcelData(trust_organisation_school11, "Connection Details",7,4);
			...
			HighlightOnElement(numberof_student_seat_employee11);
			excel.getExcelData(numberof_student_seat_employee11, "Connection Details",2,7);
			...
			HighlightOnElement(sewerage_connection_number11);
			excel.getExcelData(sewerage_connection_number11, "Connection Details",2,10);
			//Reporter.log("Sewerage Coonection Number:"+sewerageConnectionNumber11,true);
			log.info("To Verify enter the value in Sewerage Connection Number textbox sucessfully");

			HighlightOnElement(site_plan11);
			site_plan11.click();
			waitForSomeTime();
			...
			HighlightOnElement(remarks11);
			excel.getExcelData(remarks11, "Connection Details",1,12);
