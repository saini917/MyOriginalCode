...
public class ToVerifyConnectionDetailsTab_SC_03_TC_54 extends CommonLibrary
{
	 ...
	 */
	/****************************************************************************************************/
	@FindBy(xpath="//td[@class='rightColWithLeftPad']/span/span/span/div/div[2]/div/div/div[3]/table/tbody/tr/td/table/tbody/tr[2]/following-sibling::tr[7]/td[1]/table/tbody/tr/td[2]//table/tbody/tr/td/input")
	private WebElement sewerage_connection_diameter12;
	 ...
	 */
	/****************************************************************************************************/
	@FindBy(xpath="//td[@class='rightColWithLeftPad']/span/span/span/div/div[2]/div/div/div[3]/table/tbody/tr/td/table/tbody/tr[2]/following-sibling::tr[7]/td[2]/table/tbody/tr/td[2]//table/tbody/tr/td/span/div/div[1]/label/input")
	private WebElement site_plan12;
	 ...
	 */
	/****************************************************************************************************/
	@FindBy(xpath="//table[@style='width: 100%;border-collapse: collapse;border: 0;']/tbody/tr/td/table/tbody/tr[11]/td[2]/table/tbody/tr/td[2]/table/tbody/tr/td/textarea")
	private WebElement remarks12;

	public void verifyFilledFunctionality() throws InterruptedException, AWTException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		try
		{
			HighlightOnElement(sewerage_connection_diameter12);
			excel.getExcelData(sewerage_connection_diameter12, "Connection Details",2,10);
			//Reporter.log("Sewerage Connection Diameter:"+sewerageConnectionDiameter12,true);
			log.info("To Verify enter the value in Sewerage Connection Diameter textbox sucessfully");


			HighlightOnElement(site_plan12);
			site_plan12.click();
			waitForSomeTime();
			...
			HighlightOnElement(remarks12);
			excel.getExcelData(remarks12,"Connection Details",2,12);
			//Reporter.log("Remarks(if Any):"+remarksIfAny12,true);
