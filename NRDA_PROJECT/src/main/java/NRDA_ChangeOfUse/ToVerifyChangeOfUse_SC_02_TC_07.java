...
public class ToVerifyChangeOfUse_SC_02_TC_07 extends CommonLibrary
{
	...
	/****************************************************************************************************/
	/*
	 * This is the xpath of the WebElement "Connection type (Residential Cum Commercial/आवासीय सह वाणिज्यिक)".
	 * @author deepak.saini
	 * @since 2018-04-11
	 */
	/****************************************************************************************************/
	...
	public void selectConnectionType() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	{
		...
		SelectVisibleText(connectiontype,"Residential Cum Commercial/आवासीय सह वाणिज्यिक");
		waitForSomeTime();
		waitForSomeTime();
		waitForSomeTime();
		waitForSomeTime();
