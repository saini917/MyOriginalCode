...
public class ToVerifyChangeOfUse_SC_02_TC_04 extends CommonLibrary
{
	...
	/****************************************************************************************************/
	/*
	 * This is the xpath of the WebElement "Connection type (commerical/industries)".
	 * @author deepak.saini
	 * @since 2018-04-11
	 */
	/****************************************************************************************************/
	...
	public void selectConnectionType() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	{
		...
		SelectVisibleText(connectiontype,"Commercial/Industrial/वाणिज्यिक / औद्योगिक");
		waitForSomeTime();
		waitForSomeTime();
		waitForSomeTime();
		waitForSomeTime();
