...
public class NRDA_Reconnection_SC_07_TC_03 extends CommonLibrary
{
	...
	public void selectCompletedInstallation() throws InterruptedException
	{
		selectValueFromDropdown("Installation Completed");
		waitForSomeTime();
	}
	...
	public void enterComment() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	{
		...
		String comments=excel.getExcelData(comment,"Customer ID",4,9);
