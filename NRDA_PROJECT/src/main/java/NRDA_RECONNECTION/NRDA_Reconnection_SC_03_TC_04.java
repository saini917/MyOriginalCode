...
public class NRDA_Reconnection_SC_03_TC_04 extends CommonLibrary
{
	...
	@FindBy(xpath="(//div[@class='note-sheet-wrapper-left'])[1]/div/label")
	private List<WebElement> disp;
