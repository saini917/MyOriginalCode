...
public class ToverifyFunctionalityofApplicationLoginAs_LandManager extends CommonLibrary {
	...
	@FindBy(xpath="//span[contains(.,'Data')]/../following-sibling::div[1]/div/div/table/tbody/tr/td[10]/textarea")
	private WebElement LandRemark_Field;
	...
	public void toverifyLandRemarksTextboxField() throws InterruptedException
	 {		
		...
		Reporter.log("To Click on Mark_checkbox is Successfully",true);
		waitForSomeTime();
		HighlightOnElement(LandRemark_Field);
		Assert.assertNotNull(LandRemark_Field.isDisplayed(),"Test case pass");
		LandRemark_Field.sendKeys("Remarks by land manager.");
		waitForSomeTime();
	...
	public void toverifyUpdatePlotDetails() throws InterruptedException
	 {		
		...
		HighlightOnElement(LandRemark_Field);
		Assert.assertNotNull(LandRemark_Field.isDisplayed(),"Test case pass");
		LandRemark_Field.sendKeys("Remarks by legal manager.");
		waitForSomeTime();
		Reporter.log("To send data in planningRemarks Field Successfully",true);
