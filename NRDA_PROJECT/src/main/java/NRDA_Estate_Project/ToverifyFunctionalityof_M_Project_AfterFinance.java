...
public class ToverifyFunctionalityof_M_Project_AfterFinance extends CommonLibrary {
	...
	public void toverifyDepartmentDropdownFunctionality() throws InterruptedException
	{
		...
		selectValueFromDropdown("Engineering Section");
		Reporter.log("To select value in dropdown Successfully",true);
		waitForSomeTime();
		waitForSomeTime();
		waitForSomeTime();
	...
	public void toverifySelectUserFunctionality() throws InterruptedException
	{
		...
		selectValueFromDropdown("S. R. Shrivastava (CE)");
		Reporter.log("To select value in dropdown Successfully",true);
		waitForSomeTime();
		waitForSomeTime();
		waitForSomeTime();
