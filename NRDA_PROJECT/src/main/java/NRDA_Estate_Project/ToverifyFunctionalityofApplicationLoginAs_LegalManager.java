...
public class ToverifyFunctionalityofApplicationLoginAs_LegalManager extends CommonLibrary {
	...
	@FindBy(xpath="//span[contains(.,'Data')]/../following-sibling::div[1]/div/div/table/tbody/tr/td[11]/textarea")
	private WebElement LegalRemark_Field;
	...
	public void toverifyCaseDropdown() throws InterruptedException
	 {		
		HighlightOnElement(UnitPropertyDetailTab);
		Assert.assertNotNull(UnitPropertyDetailTab.isDisplayed(),"Test case pass");
		UnitPropertyDetailTab.click();
		...
		Reporter.log("To Click on Mark_checkbox is Successfully",true);
		waitForSomeTime();
		HighlightOnElement(Case_Dropdown);
		Case_Dropdown.click();
		waitForSomeTime();
	...
	public void toverifyLegalRemarksTextboxField() throws InterruptedException
	 {		
		HighlightOnElement(UnitPropertyDetailTab);
		Assert.assertNotNull(UnitPropertyDetailTab.isDisplayed(),"Test case pass");
		UnitPropertyDetailTab.click();
		...
		selectValueFromDropdown("Yes");
		waitForSomeTime();
		HighlightOnElement(LegalRemark_Field);
		Assert.assertNotNull(LegalRemark_Field.isDisplayed(),"Test case pass");
		LegalRemark_Field.sendKeys("Remarks by legal manager.");
		waitForSomeTime();
