...
public class ToverifyFunctionalityofApplicationLoginAs_PlanningManager extends CommonLibrary {
	...
	@FindBy(xpath="//span[contains(.,'Data')]/../following-sibling::div[1]/div/div/table/tbody/tr/td/div/div[2]")
	private WebElement Mark_checkbox;
	
	@FindBy(xpath="//span[contains(.,'Data')]/../following-sibling::div[1]/div/div/table/tbody/tr/td[8]/textarea")
	private WebElement PlanningRemark_Field;
	...
	public void toverifyPlanningRemarksTextboxField() throws InterruptedException
	 {		
		HighlightOnElement(UnitPropertyDetailTab);
		Assert.assertNotNull(UnitPropertyDetailTab.isDisplayed(),"Test case pass");
		UnitPropertyDetailTab.click();
		...
		Reporter.log("To Click on Mark_checkbox is Successfully",true);
		waitForSomeTime();
		HighlightOnElement(PlanningRemark_Field);
		Assert.assertNotNull(PlanningRemark_Field.isDisplayed(),"Test case pass");
		PlanningRemark_Field.sendKeys("Remarks by planning manager");
		waitForSomeTime();
	...
	public void toverifyEnterCommentsField() throws InterruptedException
	{
		...
		waitForSomeTime();
		waitForSomeTime();
		EnterCommentsField.sendKeys("Project Creation Request Forwarded to Planning Manager ");
		waitForSomeTime();
		waitForSomeTime();
