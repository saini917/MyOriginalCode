...
public class NRDA_Estate_VerifyFunctionalityLoginAs_Manager_AfterPlanning extends URLPageWSNRDAScript
{
	...
	public void NRDA_Estate_SC_016_TC_001(String username,String password) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException, AWTException
		{
			...
			ToverifyFunctionalityof_M_Project_AfterPlanning M_Login=PageFactory.initElements(driver,ToverifyFunctionalityof_M_Project_AfterPlanning.class);
