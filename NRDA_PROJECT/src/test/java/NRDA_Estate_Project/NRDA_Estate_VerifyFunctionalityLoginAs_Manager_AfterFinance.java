...
public class NRDA_Estate_VerifyFunctionalityLoginAs_Manager_AfterFinance extends URLPageWSNRDAScript
{
	...
	public void NRDA_Estate_SC_022_TC_001(String username,String password) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException, AWTException
		{
			...
			ToverifyFunctionalityof_M_Project_AfterFinance M_Login=PageFactory.initElements(driver,ToverifyFunctionalityof_M_Project_AfterFinance.class);
