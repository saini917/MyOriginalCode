...
public class NRDA_RTICitizenWithout_BPL extends URLPageWSNRDAScript
	{
		...
		public void NRDA_RTI_SC_03_TC_006(String username,String password) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException, AWTException
		{
			WaterAndSewerageLoginPage logina_citizen=PageFactory.initElements(driver,WaterAndSewerageLoginPage.class);
			logina_citizen.loginAsCitizen(username, password);
		...
		public void NRDA_RTI_SC_03_TC_007(String username,String password) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException, AWTException
		{
			WaterAndSewerageLoginPage logina_citizen=PageFactory.initElements(driver,WaterAndSewerageLoginPage.class);
			logina_citizen.loginAsCitizen(username, password);
		...
		@Test(description="VerifytheResetButton_SC_03_TC_13",priority=14,dataProvider ="citizen")
		...
		@Test(description="VerifytheCloseButton_SC_03_TC_13",priority=15,dataProvider ="citizen")
...
//		}
		...
		@Test(description="VerifytheApplicanrabletoSuccessfulpayment_SC_04_TC_01",priority=21,dataProvider ="citizen")
