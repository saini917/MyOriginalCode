...
public class Screenshot extends BrowserLaunching implements ITestListener,IRetryAnalyzer
{
...
/********************************************************************************************************************/
	...
	public void transform(ITestAnnotation testannotation, Method testMethod) 
	{
