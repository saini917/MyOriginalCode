...
public class LoginAsBOD extends HRMS_URL
{
	...
	public void UAT_Finance_AA_45(String Username,String Password) throws InterruptedException
	{
	...
	public void UAT_Finance_AA_46(String Username,String Password) throws InterruptedException
	{
		LoginPageHRMS loginhrms=PageFactory.initElements(driver,LoginPageHRMS.class);
		loginhrms.hrms_BOD(Username,Password);
	...
	@Test(priority=3,description="verify Technical Section",dataProvider="AA BOD",alwaysRun=true)
	public void UAT_Finance_AA_47(String Username,String Password) throws InterruptedException
	{
		LoginPageHRMS loginhrms=PageFactory.initElements(driver,LoginPageHRMS.class);
		loginhrms.hrms_BOD(Username,Password);
	...
	public void UAT_Finance_AA_48(String Username,String Password) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException, AWTException
	{
		LoginPageHRMS loginhrms=PageFactory.initElements(driver,LoginPageHRMS.class);
		loginhrms.hrms_BOD(Username,Password);
