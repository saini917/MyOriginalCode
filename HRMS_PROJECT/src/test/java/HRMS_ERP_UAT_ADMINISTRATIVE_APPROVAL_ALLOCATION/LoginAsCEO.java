...
public class LoginAsCEO extends HRMS_URL
{
	...
	public void UAT_Finance_AA_18(String Username,String Password) throws InterruptedException
	{
	...
	public void UAT_Finance_AA_19(String Username,String Password) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		LoginPageHRMS loginhrms=PageFactory.initElements(driver,LoginPageHRMS.class);
		loginhrms.hrms_CEO(Username,Password);
	...
	@Test(priority=3,description="verify Project Estimate",dataProvider="AA CEO",alwaysRun=true)
	public void UAT_Finance_AA_20(String Username,String Password) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		LoginPageHRMS loginhrms=PageFactory.initElements(driver,LoginPageHRMS.class);
		loginhrms.hrms_CEO(Username,Password);
	...
	public void UAT_Finance_AA_21(String Username,String Password) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		LoginPageHRMS loginhrms=PageFactory.initElements(driver,LoginPageHRMS.class);
		loginhrms.hrms_CEO(Username,Password);
