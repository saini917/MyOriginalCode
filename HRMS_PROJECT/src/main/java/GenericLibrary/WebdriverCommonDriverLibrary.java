...
public class WebdriverCommonDriverLibrary
{
	 ...
	 */
	/*********************************************************************************************************/
	public WebElement fluentWait(WebElement display)
	{
	...
	{
		List<WebElement> selectallvalue=driver.findElements(By.xpath("//ul[@class='ui-autocomplete ui-front ui-menu ui-widget ui-widget-content']/li/a"));
		try 
		{
