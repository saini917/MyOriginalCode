...
public class EnquiryOfficerStatusPage extends WebdriverCommonDriverLibrary
{
	...
	/****************************************************************************************************/
	/*
	 * This is the xpath of the WebElement "Enquiry in process".
	 * @author deepak.saini
	 * @since 2018-11-23
	 */
	/****************************************************************************************************/
	@FindBy(xpath="//td[contains(text(),'Enquiry In Process')]")
	private WebElement response;
	
	public void clickOnEnqOfficerStatus() throws InterruptedException{
